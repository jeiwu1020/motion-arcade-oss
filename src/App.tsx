...
const BadmintonGameScreen = lazy(
  () =>
    import.meta.env.DEV
...
const RunningRaceGameScreen = lazy(
  () =>
    import.meta.env.DEV
      ? import('./games/running-race/RunningRaceGameScreen')
      : import('./games/running-race/RunningRacePoseGameScreen'),
)
const SwimmingGameScreen = lazy(
  () =>
    import.meta.env.DEV
      ? import('./games/swimming/SwimmingGameScreen')
      : import('./games/swimming/SwimmingPoseGameScreen'),
)
const HighJumpGameScreen = lazy(
  () =>
    import.meta.env.DEV
      ? import('./games/high-jump/HighJumpGameScreen')
      : import('./games/high-jump/HighJumpPoseGameScreen'),
)
const LongJumpGameScreen = lazy(
  () =>
    import.meta.env.DEV
      ? import('./games/long-jump/LongJumpGameScreen')
      : import('./games/long-jump/LongJumpPoseGameScreen'),
)
const BaseballGameScreen = lazy(
  () =>
    import.meta.env.DEV
...
function App() {
  ...
  if (screen === 'BADMINTON') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <BadmintonGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  if (screen === 'RUNNING_RACE') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <RunningRaceGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  if (screen === 'SWIMMING') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <SwimmingGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  if (screen === 'HIGH_JUMP') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <HighJumpGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  if (screen === 'LONG_JUMP') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <LongJumpGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  if (screen === 'BASEBALL') {
    return (
      <Suspense fallback={<LabLoadingScreen />}>
        <BaseballGameScreen onExit={() => navigate('HOME')} />
      </Suspense>
    )
  }
  ...
  return (
    <HomeScreen
      ...
      onOpenRunningRace={() => navigate('RUNNING_RACE')}
      onOpenSwimming={() => navigate('SWIMMING')}
...
function HomeScreen({
  ...
  readonly onOpenRunningRace: () => void
  readonly onOpenSwimming: () => void
